...
public class BuyEffectMenu {

    private static final int menuSlotsPerRow = 9;
    private static final int menuSize = 45;
    private static final String menuName = new Messaging.MessageFormatter().format("menu.buyeffect-menu-title");
    private static final String premissionPrefix = "swr.effect.";
    
    public BuyEffectMenu(final GamePlayer gamePlayer) {
            ...
            if (effect.getCost() != -1) {
                if (!gamePlayer.inGame()) {
                    if (!hasEffectPermission(gamePlayer, effect)) {
                    	...
                    	loreList.add(new Messaging.MessageFormatter().format("menu.buyeffect-purchased"));
                    }            
